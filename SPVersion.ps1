$string = "Data Source=Local;Integrated Security=SSPI;Initial Catalog=SharePoint_Config_DB"

$cn = new-object system.data.SqlClient.SqlConnection($string)
...
$dt = new-object "System.Data.DataTable" "dsVersionInfo"
$dt = $ds.Tables[0]
$dt | FOREACH-OBJECT { "VersionID:  " + $_.VersionID + " - Code Version DataBase: " + $_.Version }
